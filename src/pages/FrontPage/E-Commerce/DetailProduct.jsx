                        ...
                        <div className="w-full grid md:grid-cols-2 gap-5 bg-white shadow-md p-3 rounded-md">
                            ...
                            <div className="flex flex-col justify-between h-full">
                                ...
                                <div className="flex justify-between pt-5">
                                    ...
                                    <h2>Stok: {dataJson?.available_stock} kg</h2>
                                </div>
                    ...
                    <div className="bg-white hidden md:block rounded-md shadow-md h-[200px] sticky top-[100px] p-5">
                        ...
                        <form onSubmit={(e) => e.preventDefault()} className="pt-3">
                            ...
                            <div className="relative">
                                <span className="absolute right-2 translate-y-2 bg-white">/ kg</span>
                                <input 
                                    type="number" 
                                    min={1} 
                                    id="amount" 
                                    ...
                                    className="w-full border rounded-md py-2 pl-2 pr-10" 
                        ...
                        <div className="w-full pt-4">
                            <div className="flex space-x-2 w-full">
                                <button 
                                    ...
                                    className={`p-2 rounded-md shadow-md border-gray-300 ${isAddingToCart ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-50'} transition-all`}
                                >
                                ...
                                <button 
                                    disabled={amount < 1} 
                                    onClick={() => navigate('/checkout', { state: { dataJson, amountProduct: amount } })} 
                                    className={`w-full ${amount < 1 ? "bg-gray-300" : "bg-green-600 hover:bg-green-700"} transition-all rounded-md text-white font-semibold`}
                                >
                                    Beli
                                </button>
                            </div>
                    ...
                    <div className="fixed md:hidden bg-green-600 bottom-0 left-0 w-full flex space-x-4 p-5">
                        ...
                        <div className="flex space-x-2">
                            <button 
                                onClick={handleAddToCart}
                                disabled={isAddingToCart}
                                className={`p-2 rounded-md shadow-md border-gray-300 text-white bg-yellow-500 ${isAddingToCart ? 'opacity-50 cursor-not-allowed' : ''} transition-all`}
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cart3" viewBox="0 0 16 16">
                                    <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5M3.102 4l.84 4.479 9.144-.459L13.89 4zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4m7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4m-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2m7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2"/>
                                </svg>
                            ...
                            <button 
                                disabled={amount < 1} 
                                onClick={() => navigate('/checkout', { state: { dataJson, amountProduct: amount } })} 
                                className={`${amount < 1 ? "bg-gray-300" : "bg-white hover:bg-green-700"} transition-all rounded-md text-green-600 font-semibold px-4`}
                            >
                                Beli
                            </button>
                        </div>
