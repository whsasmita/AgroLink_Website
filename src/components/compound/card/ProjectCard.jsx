      ...
      <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-xl">
        <div className="text-center">
          ...
          <p className="mt-3 text-base text-gray-600">
            Anda harus melengkapi biodata pekerja Anda terlebih dahulu sebelum
            dapat melamar proyek.
          </p>
        </div>
        {/* Tombol Aksi */}
              ...
              applicationStatus !== "already_applied" && (
                <>
                    ...
                    <div className="flex">
                      ...
                      <div className="text-sm text-blue-700">
                        ...
                        <ul className="space-y-1 list-disc list-inside">
                          <li>
                            Pastikan Anda dapat berkomitmen penuh pada jadwal
                            proyek
                          </li>
                  ...
                  <p className="mb-6 text-sm text-gray-600">
                    ...
                    <strong>"{title}"</strong>? Pastikan Anda telah membaca
