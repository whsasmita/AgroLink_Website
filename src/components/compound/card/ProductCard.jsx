...
export default function ProductCard({id, name, rating, image}){
    ...
    return (
        <>
            ...
            <div className="bg-white h-[280px] sm:h-[300px] w-full shadow-sm hover:shadow-lg border border-gray-100/90 rounded-2xl overflow-hidden relative transition-all duration-300 flex flex-col justify-between group">
                {/* Image */}
                <div
                    className="h-[140px] sm:h-[160px] w-full bg-cover bg-center transition-transform duration-500 group-hover:scale-105"
                    style={{ backgroundImage: `url(${image})` }}
                ></div>

                {/* Content */}
                <div className="flex flex-col justify-between flex-1 p-3.5 sm:p-4">
                    {/* Product Info */}
                    <div className="flex justify-between items-start gap-2">
                        <h1 className="font-bold text-sm sm:text-base text-gray-800 break-words line-clamp-2 leading-snug group-hover:text-main transition-colors">
                            {name}
                        </h1>

                        <div className="flex items-center gap-1 bg-amber-50 px-2 py-0.5 rounded-full border border-amber-200/50 flex-shrink-0">
                    ...
                    <div className="pt-3">
                        <div className="flex items-center gap-2 w-full">
                            ...
                            <button 
                                onClick={openModal} 
                                className="p-2 sm:p-2.5 rounded-xl border border-gray-200 hover:bg-green-50 hover:text-main hover:border-main/30 text-gray-600 transition-all flex-shrink-0"
                            ...
                            <button 
                                ...
                                className="flex-1 bg-main hover:bg-green-600 rounded-xl text-white font-semibold text-xs sm:text-sm py-2 sm:py-2.5 transition-all shadow-sm hover:shadow-md"
                            >
                                Beli Sekarang
                            </button>
                        </div>
