...
export const BASE_URL = import.meta.env.VITE_API_BASE_URL || (import.meta.env.DEV ? DEFAULT_DEV_BASE_URL : DEFAULT_PROD_BASE_URL);
...
const resolveWsUrl = (baseUrl) => {
	...
	try {
		...
		return import.meta.env.DEV ? "ws://localhost:8090/api/v1/ws" : "wss://api.goagrolink.com/api/v1/ws";
	}
};
